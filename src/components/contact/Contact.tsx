        ...
        <div className={styles.contactContent}>
          ...
          <div className={styles.contactInfo}>
            ...
            <div className={styles.contactCard}>
              ...
              <span className={styles.contactCardData}>+380 68 733 61 68</span>
              <a className={styles.contactButton} rel="noreferrer" target="_blank" href="https://t.me/anywlhere">Write me <i className={`${styles.contactButtonIcon} bx bx-rigth-arrow-alt`} /></a>
            </div>
            <div className={styles.contactCard}>
              ...
              <a className={styles.contactButton} rel="noreferrer" target="_blank" href="https://www.linkedin.com/in/denys-poltorak-b14579292/">Follow me <i className={`${styles.contactButtonIcon} bx bx-rigth-arrow-alt`} /></a>
            </div>
          </div>
        </div>
        <div className={styles.contactContent}>
